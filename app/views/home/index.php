    ...
    <div class="w-full rounded-xl">
        <?php foreach( $data['task'] as $task ) :  ?>
            ...
            <div class="" id="more">
                ...
                <div id="more" class="absolute w-[170px] bg-sky-300  rounded-lg ">
                    <!-- !!!form edit task akan muncul jika tombol titik 3 ditekan (belum selesai)-->
 <div id="editform" class="w-full rounded-xl mt-2 border-1 border-gray-400/40 p-2">
...
<form action="<?=BASEURL;?>home/edit" method="post">
    ...
    <div class="p-4 flex gap-2">
        ...
        <div class="flex gap-2 items-center">
        <input type="radio" name="priority" id="priority2" value="blue" class="hidden peer">
        ...
        <div class="flex gap-2 items-center">
        <input type="radio" name="priority" id="priority3" value="orange" class="hidden peer" required>
    ...
    <button type="submit" class="bg-sky-500 rounded-lg pt-2 pl-4 pr-4 pb-2 font-medium text-[#ffffff] cursor-pointer hover:bg-[#1A7DCE] transition duration-200 ease-in-out hover:transition hover:duration-200 hover:ease-in-out">save</button>
    <!-- </div> -->
</form>
